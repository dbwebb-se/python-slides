...
# None is test, is tests whether two variables poiont to the same object in the memory.
value = None
if value is None:
...
# Two varibles are created on different places (addresses) in the memory with exactly the same content (values)
value_1 = 0
value_2 = 0
for i in range(100):
    value_1 += i
...
print(value_1)
print(value_2)
print("Addressses in the memory")
print(id(value_1))
print(id(value_2))
print(value_1, "equals", value_2, "=", value_1==value_2)
print(value_1, "is", value_2, "is", value_1 is value_2)
